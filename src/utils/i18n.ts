...
const translations: Record<Locale, Record<string, string>> = {
  de: {
    ...
    "map.details.contact.telegram": "Telegram: {{handle}}",
  ...
  en: {
    ...
    "map.filter.activeOnly": "Show active meetups only",
    ...
    "map.footer.single": "{{count}} meetup on the map",
    "map.footer.plural": "{{count}} meetups on the map",
    "map.info.howTo.title": "🎯 How to use the map",
    "map.info.howTo.step1": "Click markers for details",
    "map.info.howTo.step2": "Use filters to refine the view",
    "map.info.howTo.step3": "Zoom for additional context",
    "map.info.howTo.step4": "Contact meetups directly",
    "map.info.add.title": "➕ Add a meetup",
    "map.info.add.description":
      "Missing your meetup? Reach out or submit a new event to get listed.",
    "map.info.add.contactButton": "📧 Contact us",
    "map.info.add.submitButton": "📅 Submit event",
    "map.related.title": "🔗 More resources",
    "map.related.events": "Events",
