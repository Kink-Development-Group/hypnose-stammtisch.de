    ...
    public static function getEvents(): array
    {
        return [
            [
                ...
                'description' => 'Ein Einführungsworkshop für alle, die mehr über Hypnose erfahren möchten. Wir behandeln die Grundlagen der Hypnose, verschiedene Techniken und praktische Anwendungen.',
                'short_description' => 'Grundlagen der Hypnose für Einsteiger',
                'start_date' => date('Y-m-d', strtotime('+7 days')),
                'start_time' => '19:00:00',
                'end_date' => date('Y-m-d', strtotime('+7 days')),
                'end_time' => '21:30:00',
                'location' => 'Hypnosezentrum München',
                'address' => 'Maximilianstr. 12, 80539 München',
                'price' => 25.00,
                'max_participants' => 20,
                'current_participants' => 8,
                'category' => 'workshop',
                'tags' => 'einsteiger,grundlagen,workshop',
                'organizer_name' => 'Dr. Maria Schmidt',
                'organizer_email' => 'maria.schmidt@hypnose-muenchen.de',
                'organizer_phone' => '+49 89 12345678',
                'is_featured' => true,
                'is_published' => true,
                'requires_registration' => true,
                'registration_deadline' => date('Y-m-d', strtotime('+5 days')),
                'image_url' => 'https://example.com/images/workshop-intro.jpg',
                'external_url' => 'https://hypnose-muenchen.de/workshops/einfuehrung',
                'created_at' => date('Y-m-d H:i:s', strtotime('-30 days')),
                'updated_at' => date('Y-m-d H:i:s', strtotime('-1 day'))
            ],
            [
                'id' => 2,
                'title' => 'Hypnose bei Stress und Burnout',
                'slug' => 'hypnose-bei-stress-und-burnout',
            ...
            [
                'id' => 3,
                'title' => 'Stammtisch München - Monatliches Treffen',
                'slug' => 'stammtisch-muenchen-monatlich',
                'description' => 'Unser regelmäßiger Stammtisch für alle Hypnose-Interessierten. Austausch, Networking und interessante Gespräche in lockerer Atmosphäre.',
                'short_description' => 'Monatlicher Hypnose-Stammtisch',
                'start_date' => date('Y-m-d', strtotime('first thursday of next month')),
                'start_time' => '19:30:00',
                'end_date' => date('Y-m-d', strtotime('first thursday of next month')),
                'end_time' => '22:00:00',
                'location' => 'Augustiner Bräu München',
                'address' => 'Landsberger Str. 19, 80339 München',
                'price' => 0.00,
                'max_participants' => null,
                'current_participants' => 0,
                'category' => 'stammtisch',
                'tags' => 'stammtisch,networking,austausch,münchen',
                'organizer_name' => 'Hypnose Stammtisch München',
                'organizer_email' => 'muenchen@hypnose-stammtisch.de',
                'organizer_phone' => null,
                'is_featured' => true,
                'is_published' => true,
                'requires_registration' => false,
                'registration_deadline' => null,
                'image_url' => 'https://example.com/images/stammtisch.jpg',
                'external_url' => null,
                'created_at' => date('Y-m-d H:i:s', strtotime('-60 days')),
                'updated_at' => date('Y-m-d H:i:s', strtotime('-5 days')),
                'rrule' => 'FREQ=MONTHLY;BYDAY=1TH' // Erster Donnerstag im Monat
            ],
            [
                'id' => 4,
                'title' => 'Hypnose für besseren Schlaf',
                'slug' => 'hypnose-fuer-besseren-schlaf',
                'description' => 'Entdecken Sie, wie Hypnose Ihnen zu besserem und erholsamerem Schlaf verhelfen kann. Praktische Techniken und Audio-Aufnahmen inklusive.',
                'short_description' => 'Besser schlafen mit Hypnose',
                ...
                'category' => 'webinar',
                'tags' => 'schlaf,online,gesundheit,entspannung',
                'organizer_name' => 'Sandra Klein',
                'organizer_email' => 'sandra.klein@hypno-online.de',
                'organizer_phone' => null,
                'is_featured' => false,
                'is_published' => true,
                'requires_registration' => true,
