...
class EmailService
{
    ...
    public static function sendPasswordResetEmail(
        ...
        try {
            ...
            // Email subject
            $mail->Subject = 'Passwort zurücksetzen - Hypnose Stammtisch Admin';
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #f4f4f4; border-radius: 5px; padding: 20px; margin-bottom: 20px;">
        ...
        <p>Sie haben eine Anfrage zum Zurücksetzen Ihres Passworts für das Hypnose Stammtisch Admin-Panel gestellt.</p>
    ...
    <p style="color: #999; font-size: 12px; text-align: center;">
        © 2025 Hypnose Stammtisch. Alle Rechte vorbehalten.
    </p>
</body>
</html>
HTML;
    ...
    private static function getPasswordResetEmailText(
        ...
        return <<<TEXT
Passwort zurücksetzen - Hypnose Stammtisch Admin

Hallo {$recipientName},

Sie haben eine Anfrage zum Zurücksetzen Ihres Passworts für das Hypnose Stammtisch Admin-Panel gestellt.
...
TEXT;
    ...
    public static function sendEmailChangeConfirmation(
        ...
        try {
            ...
            // Email subject
            $mail->Subject = 'E-Mail Änderung bestätigen - Hypnose Stammtisch';
            
            // HTML body
            $escapedUrl = htmlspecialchars($confirmUrl, ENT_QUOTES, 'UTF-8');
            $mail->Body = <<<HTML
<p>Bitte bestätige die Änderung deiner E-Mail-Adresse.</p>
<p><a href="{$escapedUrl}">E-Mail jetzt bestätigen</a></p>
<p>Falls du das nicht warst, ignoriere diese Nachricht.</p>
HTML;
