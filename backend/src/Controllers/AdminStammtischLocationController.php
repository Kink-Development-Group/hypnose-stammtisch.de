...
class AdminStammtischLocationController
{
  ...
  public static function update(string $id): void
  {
    ...
    try {
      ...
      if (isset($input['name'])) $location->name = $input['name'];
      if (isset($input['city'])) $location->city = $input['city'];
      if (isset($input['region'])) $location->region = $input['region'];
      if (isset($input['country'])) $location->country = $input['country'];
      if (isset($input['latitude'])) $location->latitude = (float)$input['latitude'];
      if (isset($input['longitude'])) $location->longitude = (float)$input['longitude'];
      ...
      if (isset($input['meeting_address'])) $location->meetingAddress = $input['meeting_address'] ?: null;
      if (isset($input['next_meeting'])) $location->nextMeeting = $input['next_meeting'] ?: null;
      if (isset($input['tags'])) $location->tags = $input['tags'];
      if (isset($input['is_active'])) $location->isActive = (bool)$input['is_active'];
      if (isset($input['status'])) $location->status = $input['status'];
