...
try {
  ...
  $db->exec("
        CREATE TABLE IF NOT EXISTS events (
            ...
            category ENUM('workshop', 'stammtisch', 'practice', 'lecture', 'special', 'convention', 'party') DEFAULT 'stammtisch',
  ...
  $db->exec("
        CREATE TABLE IF NOT EXISTS event_series (
            ...
            default_category ENUM('workshop', 'stammtisch', 'practice', 'lecture', 'special', 'convention', 'party') DEFAULT 'stammtisch',
